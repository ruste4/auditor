...
CREATE TABLE IF NOT EXISTS weighing (
    ...
    CONSTRAINT FK_WEIGHING_ON_CONTAINER FOREIGN KEY (container_id) REFERENCES containers (id),
    CONSTRAINT FK_WEIGHING_ON_REVISION FOREIGN KEY (revision_id) REFERENCES revisions (id)
);